...
int main() {
    ...
    std::cout << "Метод пол.дел." << halfDivisionMethod(f2, 0.1).printTable() << "          " << halfDivisionMethod(f2, 0.01).printTable() << "           " << halfDivisionMethod(f2, 0.0001).printTable() << std::endl;
    std::cout << "Метод сек.    " << secantMethod(f2, 0.1).printTable() << "       " << secantMethod(f2, 0.01).printTable() << "          " << secantMethod(f2, 0.0001).printTable() << std::endl;
}
